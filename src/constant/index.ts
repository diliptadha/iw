...
export const Strings = {
    ...
    term_para2: "IKSANA OPTICALS LLP reserves the right to change these terms and conditions from time to time without any obligation to inform you and it is your responsibility to look through them as often as possible. All rights including copyright, in this website are owned by Iksana Opticals LLP. Any use of this website or its contents, including copying or storing it in whole or part without the permission of Iksana Opticals LLP is prohibited.",
    term_para3_1: "If you have any queries about these terms and conditions or any complaints or suggestions regarding our website, please feel free to write to ",
    term_para3_anchor: "support@iksanaopticals.in",
    term_para3_2: "or call us on 7977994474 (Timings: 10.00 A.M to 6.00 P.M Indian Standard Time).",
    term_head1: "Eligibility Criteria",
    term_head1_para1: "If you are below 18 years of age, you are prohibited to use/purchase/contract from or with this website. Persons who are incompetent to contract within the meaning of the Indian Contract Act, 1872 are not eligible to use this website.",
    term_head1_para2: "Those who choose to access this website from outside India are responsible for compliance with local laws and if to the extent local laws are applicable. In case if any Indian states prohibit direct sale of merchandise from other states and require special documentation to effect such a sale without dual taxation, if we receive an order from such states or to be delivered to such states under such circumstances we retain the right to accept or reject the order.",

    term_head2: "Pricing And Payment",
    term_head2_para1: "For orders being shipped within India, the payment can only be accepted in INR. Prices will be MRP and CGST/SGST and IGST, as applicable.",
    term_head2_para2: "In case of international credit cards being used for domestic orders, the transaction amount will be converted to INR before the payment is accepted. Currency conversion charges may apply according to your credit card policy. If you have made the payment by International card or foreign bank issued card then you will be required to send us any government issued photo Identity proof of the country of residence as mentioned below",
    term_head2_l1: "a) Passport with Visa Copy",
    term_head2_l2: "b) Driving license",
    term_head2_l3: "c) Employment card",
    term_head2_l4: "d) Any other government issued ID proof of the the country of residence.",
    term_head2_para3: "International Orders:Payments for International Orders are accepted through account transfer gateway by using International credit/debit cards and other acceptable payment options only. For orders being shipped outside India, the payment will be accepted only in INR by conversion from other currencies. .For international orders, currency conversion rates will apply according to the prevailing exchange rates on the day of placing the order.",
    term_head2_para4: "For shipments being sent outside India, Prices will include all the applicable taxes in India and the shipping and handling charges.",
    term_head2_para5: "For International Orders you will be required to send us government issued photo Identity proof preferably:",
    term_head2_l5: "a) Driving License",
    term_head2_l6: "b) Passport",
    term_head2_para6: "Indian issued cards will not be accepted for international orders.",
    term_head3: "Delivery Schedule",
    term_head3_para1: "We understand that your privacy is important to you and we respect that. We ensure you that we maintain complete confidentiality of the details that you have shared with us and will not share it with any third party.",
    term_head3_para2: "A tentative delivery date/time will be given along with the order confirmation email. The exact delivery date shall be provided as soon as your order is ready for dispatch. Alternatively, registered customers can track their order by clicking Track Order and find the order status. Similarly guest users can track their order by clicking here",

    term_head4: "Your Obligations",
    term_head4_para1: "a) You have to provide true, accurate, current and complete information about yourself while registration on www.iksanaopticals.in",
    term_head4_para2: "b) You should maintain and promptly update registration data to keep it true, accurate, current and complete. If you provide any information that is false, inaccurate, incomplete or not current or if iksana opticals has reasonable grounds to suspect that such information is false, inaccurate, incomplete, not current or not in accordance with this user agreement, we have the right to indefinitely suspend or terminate your membership and refuse to provide you with access to our website.",
    term_head4_para3: "c) In the event that a non-delivery occurs on account of a mistake by you (i.e. wrong name or address or any other wrong information), any extra cost incurred by iksana opticals for re-delivery shall be claimed from you and you shall bear such expenses.",
    term_head4_para4: "d) You will provide authentic and true information in all instances where such information is requested of you. iksana opticals reserves the right to confirm and validate the information and other details provided by you at any point of time. Further, iksana opticals also reserves the right to ask for additional information for accepting orders or before making delivery in certain cases. If upon confirmation, your details are found to be false (partially or completely), iksana opticals has the right in its sole discretion to reject the registration and debar you from using the services of www.iksanaopticals.in in and or other affiliated websites without prior intimation whatsoever.",
    term_head4_para5: "e) You confirm that the address at which delivery of the product(s), ordered by you, is to be made is correct and proper in all aspects.",
    term_head4_para6: "f) Before placing an order you shall check the product description carefully. By placing an order for a product, you agree to be bound by the conditions of sale and invitation to offer included in the item's description.",
    term_head4_para7: "g) If there is any delay in the delivery caused due to any natural calamity, public holiday or any other unforeseen circumstance, then you shall not hold iksana opticals liable for such delay in the delivery of the product.",
    term_head4_para8: "h) In case you use International card or foreign bank issued card for payment of domestic order or you have ordered something to be delivered outside India, then you have to provide us any government issued photo identity proof. For example:",
    ...
    term_head5_para1: "Iksana opticals reserves the right, at its sole discretion, to limit the quantity/value of the items purchased by you and such other restrictions as may be applicable to orders placed by the same account, the same credit/debit card and also to orders that use the same billing and/ or shipping address. We will provide notification to the customer should such limits be applied. Iksana opticals reserves the right at its sole discretion to prohibit sales to anyone as it may deem fit.",

    term_head6: "Site Security",
    term_head6_p1: "You are prohibited from violating or attempting to violate the security of this website, including, without limitation:",
    term_head6_p2: "a) Accessing data not intended for you or logging onto a server or an account which you are not authorized to access.",
    term_head6_p3: "b) Attempting to probe, scan or test the vulnerability of a system or network or to breach security or authentication measures without proper authorization.",
    term_head6_p4: "c) Attempting to interfere with service to any other user, host or network, including , without limitation via means of submitting a virus to the site, overloading, flooding, spamming, mail-bombing or crashing.",
    term_head6_p5: "d) Sending unsolicited email, including promotions and or advertising of products or services;",
    term_head6_p6: "e) Forging any TCP / IP packet header or any part of the header information in any email or newsgroup, posting violations of system or network security may result in civil or criminal liability. Iksana opticals will investigate occurrences that may involve such violations and may involve, and cooperate with law enforcement authorities in prosecuting users who are involved in such violations. You agree not to use any device, software or routine to interfere or attempt to interfere with the proper working of this site or any activity being conducted on this site. You agree, further, not to use or attempt to use any engine, software, tool, agent or other device or mechanism (including, without limitation, browsers, spiders, robots, avatars or intelligent agents) to navigate or search this site other than the search engine and search agents available on this site and other than generally available third party web browsers (e.g. Microsoft Explorer, Google Chrome, Mozilla Firefox).",

    term_head7: "Cancellation By IKSANA OPTICALS LLP",
    term_head7_p1: "There may be certain orders that iksana opticals cannot accept, and therefore, we reserve the right, at our sole discretion, to refuse or cancel any order. Some reasons may include limitation on quantity available for purchase; errors in pricing or product information or certain issues identified by our fraud avoidance department or any other issue which iksana opticals identifies for not accepting the order. We also reserve the right to ask for additional information for accepting orders in certain cases. We will notify you in case your order has been cancelled fully or partially or if any additional information is required to accept your order.",

    term_head8: "Cancellation by Customer?",
    term_head8_p1: "Once an order is placed, it can only be cancelled before it is shipped to the provided destination. Registered customer can always check the status of their order from Track Order available at www.iksanaopticals.in. Once the cancellation request is received, we will initiate the process of refunding the amount to your account via the same payment mode that you had used to make the transaction or through cheque (amount would be refunded through cheque, only in cases where the debit/credit card used by customer while placing the order is not in use). Once the refund process is initiated, you will receive the refund amount directly in your account or through cheque.",
    term_head8_p2: "In the event that the amount has been deducted from your account but the transaction failed, we will refund the amount to your account at the earliest.",

    term_head9: "Return And Exchange Policy",
    term_head9_p1: "Iksana opticals is committed to ensuring full customer satisfaction with respect to the products available on our website, security & customer assistance. However, if you are not happy with the product, you can choose to return the order.",
    term_head9_p2_1: "In case of international orders, we do not currently accept any returns or exchange of our products, except for those cases where a defective product has been delivered. You shall return the defective product unused and in the same condition as you received it, in its original packaging, along with the invoice for a refund. You are required to report the defect within 7 days of receipt of the product either by calling us on 7977994474 or writing to us on ",
    term_head9_p2_anchor: "support@iksanaopticals.in.",
    term_head9_p2_2: " For the refund on the returned defective product please check the section on Refund below.",

    term_head9_t1: "7- Days Return Policy For Domestic Orders Only",
    term_head9_p3: "In the unlikely event that the order delivered is in damaged condition, or otherwise, you can return the product unused and in the same condition as you received it, in its original packaging, along with the invoice and get the refund. Our courier partner will collect the order from the address provided by you and will get it back to us.",
    term_head9_t2: "Return Charges",
    term_head9_p4: "Domestic Order:Our courier partner will collect the order from provided address (within India). Customer need not pay any shipping charges to return the product.",
    term_head9_t3: "How To Initiate The Refund Process?",
    term_head9_p5_1: "1. Customers should contact iksana opticals customer support on 7977994474 or write to ",
    term_head9_p5_anchor: "support@iksanaopticals.in",
    term_head9_p5_2: " within 7 days from the receipt of product.",
    term_head9_p6: "2. Customers should not return the product before receiving a confirmation mail from iksana opticals about the same.",
    term_head9_p7: "3. All the products must be returned in their original condition, unaltered and unused.",
    term_head9_p8: "4. Provide the invoice/guarantee card into the package for return process. Without the above, returns will not be processed.",
    term_head9_p9: " We shall not entertain any request after 7 days from the date of receipt of the product.",
    term_head9_t4: "Refund",
    term_head9_p10: "We shall process the refund once we receive the product. The product must be in unused condition, in its original packaging along with its original tags and invoice, failing which refund may not be possible.",
    term_head9_p11: "Once the refund process has been initiated, the amount will be directly refunded to your account via the same mode through which the transaction was made or through cheque (amount would be refunded through cheque, only in cases where the debit/credit card used by customer while placing the order is not in use).",
    term_head9_p12: "In case the customer pays online then amount will be refunded within 7-15 working days from the receipt of returned product(s) at the warehouse of iksana opticals.in.",

    term_head10: "Domestic Order:",
    term_head10_p1: "In case of domestic order (where the product is shipped within India) 100% refund will be made.",
    term_head10_p2: "In case the customer pays online then the amount will be refunded within 7-15 working days from the receipt of the returned product(s) at the warehouse of iksana opticals.",
    term_head10_p3: "In case of COD (Cash on delivery i.e. when customer pays in cash once the product is received) the amount can be refunded either through cheque or online transfer as NEFT (National Electronic Fund Transfer). The mode of refund depends on the customer's choice:",
    term_head10_p4: "1. If customer provides a cancelled cheque with the returned product then the refund can be made within 7-15 working days & amount will be refunded directly into customer's account through online transfer as NEFT. ",
    term_head10_p5: "2. If customer doesn't provide any cancelled cheque then amount will be refunded through cheque that will be sent by courier at the address provided by customer at time of registering/placing the order. It may take up to 30 working days.",

    term_head11: "International Order:",
    term_head11_p1: "For international orders, currently we do not provide for refund policy. Although, iksana opticals will refund the amount to the customer only under following two circumstances and at the sole discretion of iksana opticals:",
    term_head11_p2: "1. We will accept the return of only defective product and then subsequently provide for the refund. However, the refund process will be initiated only post inspection and after we get a go ahead from our QA (quality assurance) team. While refunding for the defective product, we will not charge you for shipment (to and fro).",
    term_head11_p3: "2. We will refund under those circumstances where our logistic partner has been unable to deliver the product, even after repeated efforts due to the customer's unavailability. Although while making the refund, we will deduct from the amount paid all the costs incurred by iksana opticals like shipment expenses both to and fro, customs paid and any other charges.",

    term_head12: "Exchange:",
    term_head12_p1: "We regret to inform that exchange of products is not possible for the products bought from our website.",

    term_head13: "Privacy Policy",
    term_head13_p1: "We understand that your privacy is important to you and we respect that. We ensure you that iksana optical  maintains complete confidentiality of the details that you have shared with us and will not share it with any third party except for purpose of providing product and services by iksana opticals.",
    term_head13_p2: "We may ask for certain details such as name; date of birth; e-mail address; residential address; contact number etc for registration purposes or for giving feedback , contests , newsletters and placing an order. At any point in time you can unsubscribe to our newsletters or any other information which you may receive from iksana opticals. Some of your information may be shared with and used by third parties who shall need to have access to information, such as courier companies, credit card processing companies, vendors etc. to enable them and iksana opticals to perform their duties and fulfill your order requirements. Iksana opticals does not allow any unauthorized persons or organisation to use any information that iksana opticals may collect from you through the website.",
    ...
    term_head13_p4: "For more information, please refer to Privacy Policy available at ",
    ...
    term_head20_p5: "In case of order which is to be shipped outside India customer has to bear the shipping & handling charges plus any duty as applicable at the destination.",
    term_head20_hp4: "Custom Clearance: ",
    term_head20_p6: "All shipments of products exported from India need to be cleared by the Indian Customs office. Products along with their complete documentation are filed with the authorized officer of the Indian Customs office for inspection, examination and assessment and only then delivered to your shipping address. Hence, please ignore the message on the package section which mentions: Please do not accept if the package is received in Open/ Tampered condition. You will find the package sealed with a label saying Opened for Customs.",
    term_head20_hp5: "Shipping Partner: ",
    term_head20_p7: "Our domestic logistic partner is Blue Dart, Delhivery & Ecom Express. Our international logistic partner is UPS.",
    term_head20_p8: " In case of International order, customer has to pay the shipping charges at the time of placing the order. Also, custom duty & taxes levied by destination country has to be borne by the customer and needs to be paid to the logistic partner at the time of delivery. Please note that all consignments are on Delivery Duty Unpaid (DDU) basis.",

    term_head21: "Track Order",
    term_head21_p1: "All registered customers have the option to track their orders by clicking on Track Order",

    term_head22: "Time To Deliver",
    term_head22_p1: "The time taken for delivery tends to vary according to the destination; however, we make our best efforts to ensure that the order is delivered on time.",

    PLEASE_NOTE: "PLEASE NOTE : ",
    term_head23: "Delivery Time for Domestic Orders",
    term_head23_p1: "The product is delivered within 8-10 working days in India from the day of order confirmation, provided such delivery is not delayed by any governmental authority or any other entity acting on behalf of the government or acting as per the directions of the government. In the unlikely event that we fail to deliver your order within the stipulated period, we shall cancel the order and notify you regarding the same. In such cases, the refund will be made directly to your account via the same mode through which the payment was made. We only partner with reputed courier agencies to ensure that the products reach you promptly and in perfect condition. We also ensure that the delivery is made to the recipient and thus require the identity proof for verification:",
    term_head23_p2: " Recipient needs to produce any of the following government issued photo identity proof for receiving the delivery:",
    ...
    term_head24_p1: "The product is delivered within 7-21 working days outside India from the day of order confirmation, provided such delivery is not delayed by any governmental authority or any other entity acting on behalf of the government or acting as per the directions of the government. In the unlikely event that we fail to deliver your order within the stipulated period, we shall cancel the order and notify you regarding the same. In such cases, the refund will be made directly to your account via the same mode through which the payment was made. We only partner with reputed courier agencies to ensure that the products reach you promptly and in perfect condition. We also ensure that the delivery is made to the recipient and thus require the identity proof for verification:",
    term_head24_p2: " Recipient needs to produce passport or driving license for receiving the delivery. For any customer assistance, you can call on this number 7977994474 or write to ",
    term_head24_p2_anchor: "support@iksanaopticals.in.",
    term_head24_p3: "Transit Insurance: All goods will be fully insured by iksana optical llp until they reach you, so your purchase is 100% safe.",

    term_head25: "Reviews, Feedback, Submissions",
    term_head25_p1: "All reviews, comments, feedback, postcards, suggestions, ideas and other submissions disclosed, submitted or offered in connection with your use of this website will be and remain the property of iksana opticals. Such disclosure, submission or offer of any comments shall constitute an assignment to iksana opticals of all worldwide rights, titles and interests in all copyrights and other intellectual properties in the comments.",
...
export const Faqs = {
    ...
    FAQ_P1: "Size & Fit",
    FAQ_P2_1: "We offer glasses in 5 frame sizes: Extra-Narrow, Narrow, Medium, Wide & Extra-Wide. Click",
    HERE: " here ",
    ...
    FAQ_P3: "80% - 90% of our customers find a Medium-sized frame to be the best fit.",
    FAQ_P4: "Frame Components",
    FAQ_P5: "The different components that come together to make a great frame",
    FAQ_P6: "Types of Lenses",
    FAQ_P7: "You can buy the following types of lenses on the app, our website or at any of our stores:    ",
    FAQ_H2: "The Right Prescription",
    FAQ_P8: "It is important to find the right prescription type for your eyes before you buy eyeglasses. We offer the following:",
    FAQ_H3: "Trying On Frames",
    FAQ_P9_1: "You can see how the frames look on you by using our ",
    FAQ_P9_2: "Simply follow the instructions to get a 180° view of yourself in your favourite frames.",
    FAQ_P10: "Additionally, you can visit any store or experience iksanaOpticals@Home—where you can try & buy from 150+ frames, all from the comfort of your home.",
    FAQ_H4: "Finding Out Your Power",
    FAQ_P11_1: "In order to find out your power, you can option for an eye test at iksana Opticals. You can either visit your nearest store for a free eye check-up or book a home eye test for free! The safe & thorough  ",
    EYE_STEP12: " 12-step eye test ",
    FAQ_P11_2: " will be done by a certified optometrist with the latest equipment, and you’ll be provided the prescription immediately after the check-up.",
    FAQ_H5: "Quality Assurance",
    FAQ_P12: "Quality is at the core of all iksana Opticals products. All our products are thoughtfully designed using high-quality materials like acetate, stainless steel, titanium & TR90. This ensures maximum comfort, protection, flexibility and breakage-resistance. We also offer a 1-year warranty on all our glasses.",
    FAQ_H1_TIT2: "Updating Your Power",
    FAQ_H6: "If You Don’t Have Your Prescription",
    FAQ_P13: "It is okay if you do not have your prescription handy. You can update your prescription within 7 days of purchasing any eyewear. Simply place the order and provide your power using the links shared in the SMS & email sent to you post-order completion.",
    FAQ_H7: "Submitting Your Power",
    FAQ_P14: "You can submit your power details after completing the purchase in a number of ways - by uploading a picture of your prescription, manually entering it online, requesting a call back from our team or mailing us at ",
    FAQ_H8: "Availability of Complex Powers",
    FAQ_P15: "At iksana Opticals, we stock all powers - from simple to complex. We use robotic technology to make glasses, which ensures that the most complex powers are fitted perfectly, ensuring 100% error-free glasses.",


    //POLICIES

    POL_TIT1: "Delivery",
    POL_P1: "Your order is always a priority for us. Once you place an order, there are many teams working hard to ensure that your product reaches you at the earliest without any compromise on the quality:",
    POL_H1: "Delivery Timelines",
    POL_P2: "Based on the product, power & your location, our delivery timelines will vary. To know more, please refer to the table below:",
    POL_H2: "Terms & Conditions",
    POL_P3: "The estimated delivery timelines are subject to the following conditions being met:",
    POL_L1: "The order is considered “complete” only after the power is provided by the customer for single-vision & bifocal eyeglasses. Your order will not get processed until you provide your prescription or update your power. This will lead to a delay in the delivery timelines committed.",
    POL_L2: "In order to ensure that only the best-quality eyewear reaches you, our products undergo a rigorous quality check. If during the quality check, it is observed that the product does not match the highest quality, a new product is manufactured exclusively for you. We will ensure that we still maintain the delivery timelines in these cases. However, there can be a possible delay if the quality check fails for any of the products in your order.",
    POL_TIT2: "Next day Delivery",
    POL_H3: "Next day Delivery Terms & Conditions:-",
    POL_L3: "Next day delivery is now available in: Delhi, Faridabad, Gurgaon, Ghaziabad, Noida, Hyderabad",
    ...
    POL_L6: "Includes Single vision orders (Non Toric/Non Ready stock),OTC, Zero power EyeGlasses, Zero Power Sunglasses, and Ready Power Contact Lenses",
    POL_L7: "Applies to both Ship to Customer and Ship to Store orders",
    POL_L8: "For online orders, the delivery date is the date of the first attempted delivery",
    POL_L9: "For in-store orders, the date it reaches the store is the delivery date",
    POL_L10: "Next day delivery NOT applicable for Dual vision, COD orders, Last piece and Local Fitting Orders",
    POL_L11: "If next day falls on Sunday/National Holiday, an additional day is added",
    POL_TIT3: "Refund & Exchange",
    POL_P4: "We are committed to providing you with high-quality eyewear. In the rare event that a product does not fit you or you do not like it, you can request a refund/exchange.",
    POL_H4: "Timelines For Exchange/Returns",
    POL_P5: "You can always opt for an exchange or return on your order. However, if your reason for doing so is fit or alignment, you can visit the nearest store with the product & our team will be happy to make any adjustments then & there for free. click to know the Exchange process for ",
    WEB: " web ",
    POL_H5: "Exchange",
    POL_P6: "If you wish to exchange your product, you can use any of the following options:",
    POL_L12: "Same frame & same lens package – This is the fastest option. In case you find a scratch on the lens/peel off on the frame, you can get a fresh piece of the same frame & lens package (or coating). There will be no extra charges borne by you in this case.",
    POL_L13: "Same frame & different lens package – If you feel like you could have opted for a different lens package, you can do so now. Get a fresh piece of the same frame & upgrade to a different lens package (or coating). Any additional amount for the upgrade will have to be borne by you.",
    POL_L14: "Different frame & different lens package – In case you don’t like how the frame looks on you, you can choose a new one from a wide range of different frame & lens packages. Any difference in the new & old products will have to be borne by you.",
    POL_H6: "The Return Process",
    POL_P7: "There are many ways through which you can return a product.",
    POL_H7: "Schedule a pick-up",
    POL_L15: "Raise a return request through the app in the “My Orders” section or click on “Need Help/Contact Us”.",
    POL_L16: "We provide 100% free pick-up service (few cities may be excluded) from your address within 1-2 days after the request has been raised. Please keep the product(s) ready & hand it over to our allotted pick-up partners.",
    POL_L17: "The products(s) will then be checked for quality & verified. Wrong/Damaged items & empty returns will not be proceeded.",
    POL_L18: "Post the quality check, the exchange will automatically be processed or the refund will automatically be initiated within 2-3 days.",
    POL_H8: "Ship product(s) to iksana Opticals",
    POL_P8: "In case your location is not eligible for reverse pick-up, you can courier the same to us.",
    POL_L19: "Pack the product(s) in a box.",
    POL_L20: "We will send you a return label on your registered email. Please get a printout of this label & stick it on the box.",
    POL_L21: "Ship the product to the address below using any of your preferred courier service:",
    ADDRESS: "Address:",
    P_ADD1: "IKSANA OPTICALS LLP",
    P_ADD2: "151/D, Kemps Corner",
    P_ADD3: "Mumbai, 400036.",
    POL_P9: "Note: We will reimburse up to ₹100 against the courier charges paid for the return once the product is received and on presentation of the actual courier bill. Kindly attach the courier bill in an email and share with ",
    POL_H9: "Visit the nearest store",
    POL_L22: "Our team will check the product & eligibility, and then accept/reject the return request.",
    POL_L23: "Post the return, you can exchange it for a new one immediately or request a refund, at any iksana Opticals store.",
    POL_H10: "Product Returns To Be Avoided In the Following Cases",
    POL_L24: "Alignment Issues: This can happen in new eyeglasses & can be adjusted quickly at any of our stores. Visit your nearest store & our team will be happy to resolve the issue.",
    POL_L25: "Power adjustment Issues: New glasses, especially progressives and bifocals, can take as much as 7-10 days to adjust to your eyes. We request you to please be patient and to not raise a return request for this.",
    POL_L26_1: "Accidental damage without insurance: This is not covered under iksana Opticals return policy. Click ",
    POL_L26_2: "to know more about our Insurance Policy for damages/breakages.",
    POL_H11: "Terms & Conditions",
    POL_P10: "  We allow exchange/refund for all our products with the following exceptions:",
    POL_L27: "  Eyeglasses & sunglasses with the following are not accepted for exchange/refund:",
    POL_L28: "Scratches on frame/lens that were not present at the time of delivery - We do a rigorous 3-step quality check to ensure that the product reaches you in perfect condition.",
    POL_L29: "Damaged product(s) due to mishandling post-delivery - Product is de-shaped, with visible intentional damage to the product.",
    POL_L30: "Damage to the eyewear case/any other standard packaging - The case /packaging is torn/damaged & not in the same condition as it was received.",
    POL_P11: "	Contact Lenses: Acceptable only for exceptional cases, within 14 days through our customer support centre. The lenses should be unworn, with the sealed outer packaging intact.",
    POL_P12: "	Accessories (lens cleaner, contact lens case, contact lens solution & others): Refund/Exchange is not allowed.",
    POL_P13: "	Only exchange will be provided for orders made through cash on stores and cash on delivery (COD) orders. These orders will not be eligible for refund. This is applicable for cancellation as well as returns post delivery.",
    POL_H12: "Refund",
    POL_P14: "Our refund process has the following steps :",
    POL_P15: "On an average, it takes 10-12 days for the refund to be processed, post initiation.",
    ...
    POL_P17: "This is an amount issued in lieu of the order returned to us and is credited in your iksana Opticals account. You can use this online or at any iksana Opticals store.",
    POL_H14: "Benefits",
    POL_L31: "Use it to place a new/replacement order.",
    POL_L32: "Amount is instantly credited to your account after product pick-up.",
    POL_L33: "Can be used to purchase any product online on the app/website or in stores.",
    POL_L34: "Has lifetime validity - the store credit amount will never expire.",
    POL_L35: "1 store credit = ₹1",
    POL_P18: "Note: Once issued, the store credit cannot be converted to a refund (to original source) at a later stage.",
    POL_H15: "Refund To Source",
    POL_L36: "You will get a refund back to the original source of payment through which the product was purchased.",
    ...
    POL_P19: "	Note: The amount will be credited only once the product has reached us and the quality check has been done.",
    POL_P20: "	If the amount is paid using a combination of store credit & online payment, then the respective amount will be added to your store credit & the original payment mode.",
    POL_P21: "E.g. If you paid ₹100 using store credit & ₹1500 through a debit card/other payment mode, then the amount i.e. ₹100 & ₹1500 will be refunded to your store credit & debit card/other payment mode respectively.",
    POL_H16: "Refund (for cash transactions only - Cash on Delivery on online or store orders)",
    POL_L40: "Only exchange will be provided for orders made through cash on stores and cash on delivery (COD) orders. These orders will not be eligible for refund.",
    POL_L41: "This is applicable for cancellation as well as returns post delivery",
    POL_H17: "Refund Timelines",
    POL_H18: "Terms & Conditions",
    POL_L42: "Refund will only be initiated after the product is received at our warehouse & has passed the requisite quality check.",
    POL_L43: "If you select the option of Store Credit while filing a return request, you will not be able to change it later. The store credit cannot be changed to cash refund.",
    POL_L44: "Partial refunds will not be provided on products under Buy One Get One offer",
    POL_TIT4: "Insurance For Your Eyewear",
    POL_H19: "Claiming Insurance",
    POL_P22: "We offer vision insurance to cover accidental damage/breakage of eyeglasses/sunglasses at just ₹199 per order! The insurance provider is Reliance General Insurance Company Limited (RGICL).",
    POL_H20: "How to Claim Insurance",
    POL_L45: "In case of an accident, check your billing date & hence the coverage of insurance.",
    POL_L46: "If the insurance is valid (within 1 year of billing date), you can visit any of our stores with the damaged eyewear & our team will help you out with your concern.",
    POL_L47: "The team will evaluate the damage, ascertain the genuineness of the case & file for insurance claim on your behalf. You can also put in a request for exchange/replacement of the product then & there, and pay any balance amount (if applicable).",
    POL_L48: "Once the insurance is approved (within 1-2 days), the new order will automatically get processed & dispatched to your address.",
    POL_H21: "Deductible Amount",
    POL_P23: "Whenever a customer claims insurance, iksana opticals deducts a certain amount from the product value & then generates an exchange link for the same.",
    ...
    POL_L51: "The coverage is for accidental breakage on eyeglasses/sunglasses only. RGICL reserves the right to reject a claim if the product is found to be broken intentionally or by any other reason which is not an accident.",
    POL_L52: "If the eyewear is eligible for repair, all attempts will be made to do so before the disbursement of any claim amount.",
    POL_L53: "The insurance does not cover any claims related to breakage during shipping of said product to the customer. In case you receive a damaged product, you may contact the iksana opticals customer care team by phone/email.",
    POL_L54: "Iksana Opticals & RGICL reserve the right to amend/withdraw the insurance at their sole discretion without any prior notice.",
    POL_TIT5: "Store-related Information",
    POL_H23: "Finding the Nearest Store",
    POL_P25: "If you have any questions regarding our eyewear, want to try frames or are looking to get a free eye test, walk into any of our stores in India.",
    POL_H24: "Store Timings",
    POL_P26: "Most of our stores are open from 10 AM - 6 PM, 6 days a week. However, please check the specific store timings before visiting.",
    ...
    W_P10: "We work dedicatedly to protect the security of your information during transmission by using the Secure Sockets Layer (SSL) software, which encrypts any information that you input. We constantly re-evaluate our privacy & security policies & adapt them as necessary to deal with new challenges. We do not & will not sell/rent your personal information to anyone, for any reason, at any time, unless it is:",
    W_P11: "(a) In response to a valid legal request by a law enforcement officer/ government agency or",
    W_P12: "(b) In a situation where you have explicitly/implicitly given your consent or",
    W_P13: "(c) To utilise the same for any statistical/other representation without disclosing your personal data.",
    W_P14: "We only reveal these details, as required, to enable us to access & provide you the required services related to your account.",
    W_P15: "With the exception of your Login ID (in the form of an email address), which may be provided anonymously & your third party account information (required for providing services), iksana Opticals does not require any information that might constitute personally identifiable information.",
    ...
    W_P17: "While we take the stringent measures mentioned above to protect your information, it is equally important for you to protect your account against unauthorised access (such as to your /password/phone/desktop/any other details/devices). Eg. By making sure to sign out after using a shared/public computer/laptop.",
    W_P18: "As described in this policy & with your consent, iksana Opticals will (from time to time) connect electronically to your online bank, credit card/debit card/other payment mode & other online financial accounts to process your order.",
    W_H4: "Conditions of Use & Revisions",
    W_P19: "If you choose to visit our website/M-site, your visit & any dispute over privacy is subject to this policy, including limitations on damages, arbitration of disputes & application of the law of the Republic of India. If you have any concerns about privacy, please share a detailed account with us, on the following address & we will do our best to resolve it:",
    W_ADD1: "iksana optical llp.,",
    W_ADD2: "151/D, August Kranti Marg, Near Shalimar Hotel,",
    W_ADD3: "Mumbai – 400036.",
    W_P20: "Our business will evolve constantly. So will our policies & terms of membership. The use of information that we gather is subject to the privacy policy in effect at the time of use. We may email you periodic reminders of our policies & terms & conditions, unless you have instructed us not to. We strongly recommend that you check our app/website frequently to see recent changes/updates.",

    //Faq

    F_H1: "How do I know what is the right size & fit of frame for me?",
    F_P1_1: "We offer glasses in 5 frame sizes: Extra-Narrow, Narrow, Medium, Wide & Extra-Wide. Click ",
    ...
    F_P7_1: "You can submit your power details after completing the purchase in a number of ways - by uploading a picture of your prescription, manually entering it online, requesting a callback from our team or mailing us at ",
    ...
    F_P9_1: "In order to find out your power, you can opt for an eye test at iksana Opticals. You can either visit your nearest store for a ",
    F_P9_a1: " free eye check-up ",
    F_P9_2: "or book a ",
    F_P9_a2: " home eye test ",
    F_P9_3: "for free! The safe & thorough 12-step eye test will be done by a certified optometrist with the latest equipment, who’ll provide the prescription immediately after the check-up.",
    F_H7: "I want to try the frames before making a purchase.",
    F_P10_1: "You can see how the frames look on you through our ",
    F_P10_2: "(available on the website). Simply follow the instructions & get a 180° view of yourself in your favourite frames.",
    F_P11: "Additionally, you can visit any iksana Opticals store or experience iksanaOpticals@Home—where you can try & buy from 150+ frames, all from the comfort of your home.",
    F_H8: "How many days will it take to deliver my eyeglasses?",
    F_P12: "Based on the product & power you choose for your location, our delivery timelines will vary. Our estimated delivery timelines for different types of eyeglasses are shown below:",
    ...
    F_P13: "Yes. We offer a 1-year warranty on all our glasses. To know more about what is covered in warranty.",
    F_H10: "Can I get my eyeglasses repaired/fixed?",
    F_P14: "Yes, we have the provision for repairing damaged glasses, depending on the extent of the damage. Visit your nearest iksana Opticals store with the damaged product & our team will be happy to help you.",
    F_P15: "In case a product cannot be repaired, we will give you a free replacement if you are covered under the insurance policy.",
    F_H11: "When can I cancel my order?",
    F_P16: "You can cancel your order before it has been shipped by clicking on the “Contact Us/Need Help” section on the iksana Opticals website. Please note, we custom-make every lens specifically for you. However we offer easy cancellation options as listed below so you can enjoy a 100% risk-free shopping experience.",
    ...
    F_L5_2: " for assistance or click to know more about the cancellation process for",
    F_H12: "How can I find my nearest Iksana Opticals store?",
    F_P17_1: "Click ",
    F_P17_2: "to find your nearest store or enable your location on the iksana Opticals to find the store closest to you.",
    F_H13: "If I place my order at the store, will I have to collect the products from the store only?",
    F_P18: "You may collect your order from the store or request the store team to ship it to your preferred location.",
    F_H14: "If I have placed an order online, can I collect it from the store?",
    F_P19: "Yes, absolutely. While placing your order online, you can mention that you wish to collect your order from the nearest store.",
    F_H15: "Why is it taking so long to process my order?",
    F_P20: "At iksana Opticals, we strive to deliver your order as quickly as possible. We sincerely apologise if an order is taking too long to arrive. This could be due to multiple factors, such as quality check failure, logistical issues with external courier partners, etc.",
    ...
    F_H17: "Can i get a Combined invoice for my BOGO order ?/ Can i get invoice on 0 value?",
    F_P22: "As per the financial procedures & accounting principal the total billed amount shall be distributed amongst the products governed under the BOGO offer with 50% discounted value of each. This enables the customer to make further transactions on both products such as insurance claims.",
    F_H18: "How can I escalate my issues?",
    F_P23_1: "If you want to escalate iksana Opticals Complaints there is a 2-step escalation matrix in iksana Opticals. In Level 1 you can contact us at ",
    F_P23_2: "or chat with us or email us at ",
    F_P23_3: "To escalate your complaint to Level 2 you can email us with complete Order and contact information at ",
    F_P23_4: "(Business hrs- 10AM - 8PM)",
    F_P24: "Unsubscribe",
    F_P25: "We’d love to stay in touch and & keep you updated on our latest collections, exciting offers, store launches and more! However, if you feel overwhelmed by these or wish to take a break, you can unsubscribe using the following method:",
    ...
    DAYS5_7: "5-7 days",
    DAYS7_10: "7-10 days",
    T3_L1: "If ordered along with other eyewear products, along with the other products in the order",
    ...
    NEED_MORE_HELP_ANS: "Still have unanswered questions? Don’t worry! Our experts are always here to help.",
