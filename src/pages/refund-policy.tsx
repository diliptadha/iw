    ...
    <>
      ...
      <div className="px-[2rem] py-[2rem] md:px-[3rem] xl:px-[6rem]">
        ...
        <div className="mb-[20px]">
          ...
          <h2 className="title-refund mb-[20px]">
            {Strings.EYEGLASSES_7_DAYS}
          </h2>
          <h3 className="leading-[1.8] mb-[20px] tracking-[1px] text-justify">
            {Strings.PRIVACY_1PARA}
          </h3>
          <ul className="list-disc pl-[25px]">
            <li className="r-list">
              <span className="refund-span-li">{Strings.CONTACT_LENSES}</span>{" "}
              {Strings.UL1_L1}
            </li>
            <li className="r-list">
              <span className="refund-span-li">{Strings.EYEWEAR}</span>{" "}
              {Strings.UL1_L2}
            </li>
            ...
            <li className="r-list">
              <span className="refund-span-li">{Strings.ACCESORIES_LENS} </span>
              {Strings.UL1_L6}
            </li>
            <li className="r-list">
              <span className="refund-span-li">{Strings.PARTIAL_BOGO} </span>
              {Strings.UL1_L7}
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <h3 className="refund-ques mb-[10px]">
            {Strings.SHIP_PRODUCT_IKSHANA}
          </h3>
          <ul className="list-disc pl-[25px] mb-[20px]">
        ...
        <div>
          <h2 className="title-refund underline">
            {Strings.EXCHANGE_AND_REFUND}
          </h2>
          ...
          <h4 className="underline sm:text-[20px] text-[18px] mb-[10px]">
            {Strings.STORE_CREDIT}
          </h4>
        ...
        <div>
          ...
          <h2 className="title-refund underline mb-[6px]">
            {Strings.FREQUENTLY_ASKED_QUES}
          </h2>
          {/* Q AND A */}
